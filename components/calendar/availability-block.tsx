...
export function AvailabilityBlock({
	...
	const content = (
		...
		>
			...
			{isOwn && !isPending && (
				<div
					className="hover:bg-primary/20 absolute top-0 right-0 left-0 h-2 cursor-n-resize transition-colors"
			...
			{isOwn && !isPending && (
				<div
					className="hover:bg-primary/20 absolute right-0 bottom-0 left-0 h-2 cursor-s-resize transition-colors"
