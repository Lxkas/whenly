...
export function TimeGrid({ event, day, participants, currentParticipantId, timeRange }: TimeGridProps) {
    ...
    }, [editMode, isDragging, yToTime, updateEditBlock, updateDrag, endEditBlock, endDrag, updateAvailability, saveAvailability, event.slug, event.id, currentParticipantId, currentUserBlocks, day, gridStartTime, gridEndTime]);
        ...
        <div className="relative">
            ...
            <div className="flex">
                ...
                <div
                    ref={gridRef}
                    className={cn(
                        "flex-1 relative border rounded-md bg-muted/20",
                ...
                >
                    ...
                    {dragPreview && (
                        <div
                            className="absolute left-0 right-0 bg-primary/30 border border-primary rounded pointer-events-none"
                            style={{
                                top: dragPreview.top,
