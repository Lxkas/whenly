...
export function SelectionToolbar({ selectedDays, event, currentParticipantId }: SelectionToolbarProps) {
    ...
    return (
        <div className="absolute bottom-0 left-0 right-0 p-3 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 rounded-lg border shadow-lg animate-in slide-in-from-bottom-2 duration-200">
